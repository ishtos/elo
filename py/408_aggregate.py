...
def aggregate(args):
    ...
    df['union_auth_purchase_date_diff'] = (df['union_auth_purchase_date_max'] - df['union_auth_purchase_date_min']).dt.days
    df['union_auth_purchase_date_average'] = df['union_auth_purchase_date_diff']/df['union_auth_transactions_count']
    df['union_auth_purchase_date_uptonow'] = (datetime.today() - df['union_auth_purchase_date_max']).dt.days
    df['union_auth_purchase_date_ptp'] = df['union_auth_purchase_date_ptp'].dt.days
