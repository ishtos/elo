...
def aggregate(args):
    ...
    df['new_auth_purchase_date_uptonow'] = (datetime.today() - df['new_auth_purchase_date_max']).dt.days
    df['new_auth_purchase_date_ptp'] = df['new_auth_purchase_date_ptp'].dt.days
